...
require_once '/testSimulation.php';
$testSimululation = new TestSimulation();
set_time_limit(0);
...
$to_simulate = 'Liga';
$sql1 = "SELECT id, liga, team1, team2, typ, kennung FROM ".$prefix."spiele WHERE datum > ".$datum_min." AND datum < ".$datum_max." AND typ = '".$to_simulate."' ORDER BY RAND() LIMIT 0, 20";
...
while ($sql3 = mysql_fetch_assoc($sql2)) {
	...
	$testSimululation->addResult($team1OhneKurzel.' ('.$gesamtForm_team1.')', $team2OhneKurzel.' ('.$gesamtForm_team2.')', $tore[$sql3['team1']].':'.$tore[$sql3['team2']]);
